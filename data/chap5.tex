...
\begin{table}[!htb]
    ...
    \begin{tabular}{l|c|c|c}
        ...
        Error & < 7\% & < 0.7\% & < 0.02\% \\
        \hline
        Bandwidth & $4k$ Hz & $24k$ Hz & $220k$ Hz\\
        \hline
...
Fig.\ref{fig:sim:vgGain} presents the maximum gain that the circuit provides at five corners.
...
\emph{These results show that the circuit bandwidth is about $4k Hz$, which is caused by the last amplifier block.}
