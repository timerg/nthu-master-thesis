...
\begin{figure}[!htb]
    \begin{minipage}[t]{1\textwidth}
        \centering
        \includegraphics[width=0.6\textwidth] {images/chapter5/postSim/ResAmp_1x.PNG}
        (a)
    \end{minipage}
    \hspace{8cm}
    \begin{minipage}[t]{1\textwidth}
        \centering
        \includegraphics[width=0.6\textwidth] {images/chapter5/postSim/ResAmp_10x.PNG}
        (b)
    \end{minipage}
    \begin{minipage}[t]{1\textwidth}
        \centering
        \includegraphics[width=0.6\textwidth] {images/chapter5/postSim/ResAmp_100x.PNG}
        (c)
    \end{minipage}
...
\emph{Fig.\ref{fig:sim:vgGain} presents the maximal gain that the circuit provides at five corners.
...
\begin{table}[!htbp]
    ...
    \begin{tabular}{l|c|c}
        ...
        \hline
        Input Referred Noise ($V_G$) & $< 2m V$ & $ = \frac{0.291n}{200n}$ = $1.46m V$ @1Hz
    \end{tabular}
