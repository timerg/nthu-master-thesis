...
\begin{figure}[!htbp]
    \centering
        \includegraphics[width=0.4\textwidth] {images/chapter5/mirror.PNG}
...
It is notable that the second stage circuit is only used for the transient measurement mode.
...
This measurement are usually preceded by DC-sweep mode, which initialize the $I_D$ with the value of Ibias and set $g_m$ to a corresponding value.
