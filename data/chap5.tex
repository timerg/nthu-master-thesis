...
\emphy{Fig.\ref{fig:TIA_postSim_dc} and Fig.\ref{fig:TIA_postSim_ac} are the dc and ac post-simulation of the TIA.
...
\emphy{The OpAmp of TIA holds the gain of 1000 (60dB), which makes the $Z_{in}$ of 100.
...
\emphy{We swept Ibias and measured the output voltage of the feedback OP which is also the gate voltage of SiNW in Fig.\ref{fig:DCmode}.
