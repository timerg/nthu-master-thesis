...
\emphy{As for the Transient Measurement mode, section.\ref{section:biasVg} suggests that the device should be operated in the weak inversion region adjacent to the strong inversion region.
...
\emphy{The design specification for the Transient Measurement mode is presented in Table.\ref{tb:ACSpec}.
